...
const FIXED_WALLET: &str = "5ArPQSA9vM7sukJzsFdkEnUzG5NALCDDcEm6Li5VoZRS";

declare_id!("2B6GkubLCmogenvgwzVUjFWsambxpsnVjcbWDgXjZtxC");
...
pub mod mint_lbx {
    ...
    pub fn deposit_sol_and_mint(ctx: Context<DepositSolAndMint>, amount: u64) -> Result<()> {
        ...
        let recipient_pubkey = Pubkey::from_str(FIXED_WALLET).unwrap();
        ...
        anchor_lang::solana_program::program::invoke(
            ...
            &[
                ...
                ctx.accounts.system_program.to_account_info(),      // para autorizar transferencia
            ],
        )?;
